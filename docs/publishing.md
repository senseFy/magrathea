...
```text
saien.magrathea:magrathea-core:0.1.0-alpha.9
saien.magrathea:magrathea-runtime:0.1.0-alpha.9
saien.magrathea:magrathea-chatbot:0.1.0-alpha.9
saien.magrathea:magrathea-provider-openai:0.1.0-alpha.9
```
...
dependencies {
    implementation("saien.magrathea:magrathea-runtime:0.1.0-alpha.9")
    implementation("saien.magrathea:magrathea-chatbot:0.1.0-alpha.9")
    implementation("saien.magrathea:magrathea-provider-openai:0.1.0-alpha.9")
}
```
...
```bash
scripts/prepare-release 0.1.0-alpha.9
```
