...
class StorageSchemaV7DescriptorContractTest {
    @Test
    fun livePayloadSerializersMatchFrozenV7DescriptorFingerprint() {
        val schema = buildString {
            append("storage-schema-v7\n")
            append("session\n")
        ...
        val expected = requireNotNull(
            javaClass.getResource("/v7/core/storage-schema-descriptor.sha256"),
        ).readText().trim()
