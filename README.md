...
> [!NOTE]
> This checkout targets `0.1.0-alpha.14`. Check GitHub Releases for available artifacts; APIs and <!-- x-release-please-version -->
...
```kotlin
dependencies {
    implementation("saien.magrathea:magrathea-runtime:0.1.0-alpha.14") // x-release-please-version
    implementation("saien.magrathea:magrathea-chatbot:0.1.0-alpha.14") // x-release-please-version
    implementation("saien.magrathea:magrathea-provider-openai:0.1.0-alpha.14") // x-release-please-version
}
```
...
[Release](https://github.com/senseFy/magrathea/releases/tag/v0.1.0-alpha.14). <!-- x-release-please-version -->
