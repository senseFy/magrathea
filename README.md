...
> [!NOTE]
> This checkout targets `0.1.0-alpha.12`. Check GitHub Releases for available artifacts; APIs and <!-- x-release-please-version -->
...
[Release](https://github.com/senseFy/magrathea/releases/tag/v0.1.0-alpha.12). <!-- x-release-please-version -->
